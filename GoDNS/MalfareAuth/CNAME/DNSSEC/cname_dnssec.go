 ...
 * @Description: A DNS server that responds to DNS queries with CNAME Chain with DNSSEC.
 *
 ...
 * 18/10/24 18:58      4stra       1.1.0	   CNAME NO DNSSEC TEST
 * 18/10/24 19:30      4stra       1.2.0	   CNAME DNSSEC TEST
 */
package main
