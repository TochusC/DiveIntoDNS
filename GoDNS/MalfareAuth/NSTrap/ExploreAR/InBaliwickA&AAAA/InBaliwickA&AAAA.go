 ...
 * @File    :   InBaliwickA&AAAA.go
 * @Contact :	tochus@163.com
 * @License :   (C)Copyright 2024
 * @Description: A DNS server that sends in-bailiwick A&AAAA records with their RRSIG records in the additional section.
 *
 ...
 * 16/10/24 10:25 	   4stra       0.4.0       In-bailiwick A&AAAA records within AR
 */
